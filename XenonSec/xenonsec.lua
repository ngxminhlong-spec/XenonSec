...
Options:
  ...
  --deadcode <n>   Always-false-guarded noise blocks in header/footer
                   scaffolding (default: 2, 0 disables)
  -h               Show this help
...
while i <= #args do
  ...
  elseif a == "--deadcode" then
    opts.deadcodeBlocks = tonumber(args[i + 1]); i = i + 2
  else
