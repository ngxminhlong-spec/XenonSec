...
t("register VM: mix of captured and uncaptured locals", [[
local function make()
...
t("register VM: deeply nested functions with mixed capture depths", [[
...
t("register VM: recursive function with uncaptured accumulator", [[
...
t("register VM: uncaptured for-loop var, captured for-loop var side by side", [[
local results = {}
for i = 1, 5 do results[i] = i * i end
